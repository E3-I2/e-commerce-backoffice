...
public class CustomerController {
    ...
    @LoginSessionCheck
    public ResponseEntity<CustomerResponse<PutInfoCustomerResponse>> patchInfo(@PathVariable Long customerId, @Valid @RequestBody PutInfoCustomerRequest request) {
    ...
    @LoginSessionCheck
    public ResponseEntity<CustomerResponse<PutStatusCustomerResponse>> patchStatus(@PathVariable Long customerId, @Valid @RequestBody PutStatusCustomerRequest request) {

        return ResponseEntity.ok(CustomerResponse.ok(customerService.updateStatus(customerId, request)));
    }
